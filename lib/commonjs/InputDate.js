...
class InputDate extends _react.default.Component {
  constructor(props) {
    super(props);
    ...
    _defineProperty(this, "onChange", date => {
      const value = (0, _moment.default)(date).isValid() ? (0, _moment.default)(date).format("YYYY-MM-DD") : null;
  ...
  componentDidUpdate(prevProps, prevState) {
    try {
      if ((0, _tcomponent.findArrayName)(this.state.props_name, this.props.input) != (0, _tcomponent.findArrayName)(this.state.props_name, prevProps.input) && (0, _tcomponent.findArrayName)(this.state.props_name, this.props.input) != this.state.value) {
        const value = (0, _moment.default)(this.props.input[this.state.props_name]).isValid() ? (0, _moment.default)(this.props.input[this.state.props_name]).format("YYYY-MM-DD") : null;
        this.setState({
          value
        });
        this.props.setModal(this.state.prefix, false);
    ...
    if (this.props.value && prevProps.value != this.props.value) {
      const value = (0, _moment.default)(this.props.value).isValid() ? (0, _moment.default)(this.props.value).format("YYYY-MM-DD") : null;
      this.setState({
        value
      });
    }
  ...
  render() {
    const isi = (0, _moment.default)(this.state.value).isValid() ? (0, _moment.default)(this.state.value).format("DD-MM-YYYY") : "";

    if (this.props.disabled || this.props.isReadonly) {
      return /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, isi);
    }

    return /*#__PURE__*/_react.default.createElement(_reactNative.View, null, /*#__PURE__*/_react.default.createElement(_reactNative.View, null, !this.props.customButton ? /*#__PURE__*/_react.default.createElement(_reactNative.Button, {
      onPress: this.open,
      title: "Open"
    }) : this.props.customButton(this.open)), /*#__PURE__*/_react.default.createElement(_reactNativeModalDatetimePicker.default, {
      isVisible: this.props.modal[this.state.prefix],
      date: (0, _moment.default)(this.state.value).toDate(),
      mode: "date",
      onConfirm: this.onChange,
      onCancel: this.cancel
    }), this.props.default && /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, isi));
  }
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(InputDate);
