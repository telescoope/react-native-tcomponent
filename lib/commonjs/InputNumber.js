...
class InputNumber extends _react.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactNative.TextInput, _extends({}, this.props, {
      editable: true,
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(InputNumber);
